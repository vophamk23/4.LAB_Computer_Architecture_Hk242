#For b, c and Value input read from user. Dislay value of a
#switch (input)
#{ case 1: a = b + c; break;
#case 2: a = b - c; break;
#case 3: a = b * c; break;
...
.include "macro.mac"
	.data
		...
		result_a: .word 0
    		...
    		prompt: .asciiz "Enter a value (1-4): "
	...
	.globl main
	main:
		# Print prompt and Read integer b-c from user
		geti_p prompt_b, int_b
		geti_p prompt_c, int_c
		
		# Load values of b and c
    		lw 	$t1, int_b                # $t1 = b = 100 (int_b)
    		lw 	$t2, int_c                # $t2 = c = 2 (int_c)
